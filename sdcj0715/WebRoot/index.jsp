			...
			<div class="body_left fl">
				<div class="tabs clearfix">
					...
					<div class="tabs_con">
						...
						<div class="tab">
							<ul class="tabs_list clearfix" var="item">
								<c:forEach items="${requestScope.itemList }" var="item"
									begin="0" end="5">
									<li class="fl">
										<p class="phot">
											<img src="images/${item.itemImg }" width="375" height="200">
										</p>
										<p class="name">${item.itemTitle }<i
												class="invest_ico_gray"></i>
										</p>
										<p class="tits">${item.itemUnit }</p>
										<p class="link">${item.industry.industryTitle }</p>
										<p class="weal">
											<c:forEach items="${item.typeList }" var="itemType">
												<a href="javascript:void(0);" class="one">${itemType.typeName}</a>
											</c:forEach>
										</p>
									</li>
								</c:forEach>
						...
						<div class="cst_tp">
							<div class="sct_tp_bdr clearfix">
								...
								<div class="cst_tp_r fr">
									...
									<a
										href="/CYDS_BUSINESS_DYNAMIC/information/CYDS_BUSINESS_DYNAMIC/new/list.html"
					...
					<div class="cst_box">
						<div class="cst_tp">
							<div class="sct_tp_bdr clearfix">
								...
								<div class="cst_tp_r fr">
									<a
										href="/CYDS_BUSINESS_POLICY/information/CYDS_BUSINESS_POLICY/new/list.html"
										class="cst_tp_more">更多&gt;</a>
								</div>
							</div>
						</div>
							...
							<div class="news_box">
								<ul class="news_all_list">
									<c:forEach items="${requestScope.newsList}" var="news">
										<li><a href="javascript:void(0);"> <i class="square"></i>${news.newsTitle }
										</a></li>
									</c:forEach>
								</ul>
							</div>
